...
// +kubebuilder:rbac:groups=webapp.adershrp.org,resources=redis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.adershrp.org,resources=redis/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=webapp.adershrp.org,resources=redis/finalizers,verbs=update
